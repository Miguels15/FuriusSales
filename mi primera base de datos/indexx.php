...
<html>
<head>
	<script src="solo/validacion.js"></script>
	<link rel="stylesheet" type="text/css" href="login.css">
	<link rel="stylesheet" type="text/css" href="estiloinput.css">
	<meta charset="utf-8">
...
<?php
  ...
  if ($contraseña == $contraseña2){
	echo '<script language="javascript">alert("Contraseña correcta");</script>';
}else{
	if ($contraseña != $contraseña2) {
